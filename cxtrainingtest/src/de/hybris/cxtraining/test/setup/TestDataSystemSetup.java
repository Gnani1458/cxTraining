 ...
 */
package de.hybris.cxtraining.test.setup;
...
import de.hybris.cxtraining.test.constants.CxtrainingTestConstants;
import de.hybris.cxtraining.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CxtrainingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/cxtrainingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/cxtrainingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/cxtrainingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/cxtrainingtest/import/csquotes.impex");
		}
	}
}
