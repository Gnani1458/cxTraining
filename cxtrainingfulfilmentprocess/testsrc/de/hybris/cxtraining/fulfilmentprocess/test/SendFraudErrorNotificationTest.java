...
import de.hybris.cxtraining.fulfilmentprocess.actions.order.SendFraudErrorNotificationAction;
...
public class SendFraudErrorNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.cxtraining.fulfilmentprocess.actions.order.SendFraudErrorNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
