 ...
 */
package de.hybris.cxtraining.fulfilmentprocess.test.jobs;
...
import de.hybris.cxtraining.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = CxtrainingFulfilmentProcessConstants.ORDER_PROCESS_NAME;
