 ...
 */
package de.hybris.cxtraining.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, CxtrainingFulfilmentProcessConstants.PARENT_PROCESS);
