 ...
 */
package de.hybris.cxtraining.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CxtrainingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CxtrainingFulfilmentProcessConstants.PARENT_PROCESS);
