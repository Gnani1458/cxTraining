...
import de.hybris.cxtraining.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction;
...
public class SendOrderCompletedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.cxtraining.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
