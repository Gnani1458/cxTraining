 ...
 */
package de.hybris.cxtraining.core.constants;

/**
 * Global class for all CxtrainingCore constants. You can add global constants for your extension into this class.
 */
public final class CxtrainingCoreConstants extends GeneratedCxtrainingCoreConstants
{
	public static final String EXTENSIONNAME = "cxtrainingcore";


	private CxtrainingCoreConstants()
	{
		//empty
	}
