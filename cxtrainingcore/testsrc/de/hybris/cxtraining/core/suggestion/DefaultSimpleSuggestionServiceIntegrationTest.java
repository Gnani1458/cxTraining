 ...
 */
package de.hybris.cxtraining.core.suggestion;
...
import de.hybris.cxtraining.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/cxtrainingcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
