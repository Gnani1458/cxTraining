...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/cxtrainingstorefront/electronics/en",
						"https://electronics.local:9002/cxtrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/cxtrainingstorefront/electronics/en",
						"https://electronics.local:9002/cxtrainingstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/cxtrainingstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/cxtrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/cxtrainingstorefront/electronics/en",
						"https://electronics.local:9002/cxtrainingstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/cxtrainingstorefront",
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/cxtrainingstorefront/electronics/en",
						"https://electronics.local:9002/cxtrainingstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
