 ...
 */
package de.hybris.cxtraining.storefront.controllers.pages;
...
import de.hybris.cxtraining.storefront.controllers.ControllerConstants;
...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException 
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("cxtrainingstorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("cxtrainingstorefront.quick.order.rows.max", 25)));
